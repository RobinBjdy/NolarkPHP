...
GRANT INSERT ON `nolark`.* TO 'nolarkuser'@'localhost';
...
-- ----------------------------------
insert into membre(pseudo,motDePasse,mail,naissance)
values('adminNolark','root','adminnolark@gmail.com','27/12/2001');
