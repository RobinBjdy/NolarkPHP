...
while ($ligne = $res->fetch(PDO::FETCH_OBJ)) {
    echo '<article>';
    echo '<a href="article.php?stock=', $ligne->stock, '&prix=', $ligne->prix, '&nom=', $ligne->nom, '&modele=', $ligne->modele, '"><img id="casquee" src="../images/casques/', $ligne->libelle, '/', $ligne->image,
    '" alt="', $ligne->modele, '"></a>';
